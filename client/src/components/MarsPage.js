...
export default class MarsPage extends Component {
	...
	getWeatherData = () => {
		axios
			.get(
				"https://api.nasa.gov/DONKI/FLR?startDate=2021-07-10&endDate=2021-07-22&api_key=rWoTXXeBvjPqFXL8VgQVicRTI2BLUNTmRdpbPOke&feedtype=json&ver=1.0"
			)
			.then((response) => {
	...
	render() {
		...
		return (
			<div>
				...
				<p>
					Welcome back, dear fellow Martian. As one of the first humans migrated
					to Mars, your journals are extremely valuable for the future
					generations to come.
				</p>
				<img src={picture} style={{ width: "600px" }} alt="space"></img>
				...
				<p>
					Time recorded using Earth time. Disruption to data could occur due to
